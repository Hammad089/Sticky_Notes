...
const ThursdayNotes = () => {
    ...
    const loadNotes = async () => {
        try {
            const savedNotes = await AsyncStorage.getItem('notes_thursday');
            if (savedNotes !== null) {
    ...
    const handleEditNote = (note) => {
        navigation.navigate('CreateNote', { note, noteKey: 'notes_thursday', updateNotes: loadNotes });
    };
    ...
    const saveNotes = async (updatedNotes) => {
        try {
            await AsyncStorage.setItem('notes_thursday', JSON.stringify(updatedNotes));
            loadNotes();
        } catch (error) {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity
                ...
                onPress={() => navigation.navigate('CreateNote', { noteKey: 'notes_thursday', updateNotes: loadNotes })}
            >
